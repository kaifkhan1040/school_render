...
class Contactus(models.Model):
    ...
    select_class_looking_for  = models.CharField(max_length=50,choices=[('P.Nursery','P.Nursery'),('Nursery','Nursery'),('LKG','LKG'),('UKG','UKG'),('1ST','1ST'),('2ND','2ND'),('3RD','3RD'),('4TH','4TH'),('5TH','5TH')])
